...
L'app calcola dosaggi chimici reali. **Lancia sempre la suite di test prima e dopo ogni modifica** al file `index.html`:
...
3. Verifica che la suite di test passi (`node tests/run-tests.js`).
...
- **Un solo file**: CSS, markup e JavaScript restano dentro `index.html`. Niente bundler, framework o transpiler.
